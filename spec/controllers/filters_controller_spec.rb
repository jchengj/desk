...
describe FiltersController, :type => :controller do
  before do
    stub_request(:get, "https://joseph.desk.com/api/v2/filters/2026388/cases").to_return(body: CASES_JSON_STRING)
    stub_request(:get, "https://joseph.desk.com/api/v2/filters").to_return(body: FILTERS_JSON_STRING)
    stub_request(:get, "https://joseph.desk.com/api/v2/labels").to_return(body: LABELS_JSON_STRING)
    stub_request(:get, "https://joseph.desk.com/api/v2/filters/0/cases").to_return(status: 404, body: CASE_JSON_MALFORMED)
  end
  ...
  describe "GET show" do
    ...
    it "will throw an ApiError and be rescued and handled by the application controller" do
      xhr :get, :show, {id: 0}
